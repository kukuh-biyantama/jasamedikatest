...
@endif
<form action="{{ route('store_datapasien') }}" method="POST">
    @csrf
    ...
    <div class="col">
        <div class="form-outline">
            ...
            <input type="text" id="nama_pasien" name="nama_pasien" placeholder="Masukkan Nama Pasien" class="form-control" />
        </div>
    </div>
    ...
    <div class="form-outline mb-4">
        ...
        <textarea name="alamat" id="alamat" style="width: 100%;" placeholder="masukkan alamat"></textarea>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-outline mb-4">
                ...
                <input type="number" id="rt" name="rt" class="form-control" placeholder="masukkan nomor RT" />
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-outline mb-4">
                <label class="form-label" for="form6Example5">RW</label>
                <input type="number" id="rw" name="rw" class="form-control" placeholder="masukkan nomor rw" />
            </div>
        </div>
    </div>
    <div class="form-outline mb-4">
